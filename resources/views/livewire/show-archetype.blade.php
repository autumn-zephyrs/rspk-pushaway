                                ...
                                <div class="items-center flex gap-2 mb-4">
                                    ...
                                    <div class="flex gap-2">
                                        @if($archetype->icon_primary !== 'substitute')
                                            <img class="max-h-8" src="https://r2.limitlesstcg.net/pokemon/gen9/{{$archetype->icon_primary}}.png">
                                            @if($archetype->icon_secondary)
                                                <img class="max-h-8" src="https://r2.limitlesstcg.net/pokemon/gen9/{{$archetype->icon_secondary}}.png">
                                            @endif
                                        @else
                                ...
                                <div class="{{($index % 2 == 0) ? 'bg-holon-50' : 'bg-holon-100'}} grid grid-cols-9 flex items-center">
                                    <div class="pl-3 text-gray-800 text-sm lg:text-sm lg:col-span-4 col-span-6 ml-2 border-holon-400 flex justify-between items-center">
                                        ...
                                        <div class="flex gap-2 pr-2">
                                            @if($type->icon_primary !== 'substitute')
                                                <img class="max-h-4 lg:max-h-6" src="https://r2.limitlesstcg.net/pokemon/gen9/{{$type->icon_primary}}.png">
                                                @if($type->icon_secondary)
                                                    <img class="max-h-4 lg:max-h-6" src="https://r2.limitlesstcg.net/pokemon/gen9/{{$type->icon_secondary}}.png">
                                                @endif
                                            @else
