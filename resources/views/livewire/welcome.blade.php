        ...
        <div class="grid grid-cols-1 gap-6 md:grid-cols-2 lg:gap-8">
            <a href="/latest" class="scale-100 bg-tyranitar bg-cover via-transparent dark:ring-1 dark:ring-inset dark:ring-white/5 rounded-lg shadow-2xl shadow-gray-500/20 dark:shadow-none flex motion-safe:hover:scale-[1.01] transition-all duration-250 focus:outline focus:outline-2 focus:outline-indigo-500">
                <div class="rounded-lg w-full grid grid-rows-3">
                    <div class="row-span-2 items-center flex">
                        <div class="mx-6 flex items-center justify-center w-16 h-16 rounded-full bg-indigo-50 dark:bg-slate-900/20">
                            <svg class="text-slate-100 fill-current w-7 h-7" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 512 512"><!--!Font Awesome Free 6.5.2 by @fontawesome - https://fontawesome.com License - https://fontawesome.com/license/free Copyright 2024 Fonticons, Inc.--><path d="M40 48C26.7 48 16 58.7 16 72v48c0 13.3 10.7 24 24 24H88c13.3 0 24-10.7 24-24V72c0-13.3-10.7-24-24-24H40zM192 64c-17.7 0-32 14.3-32 32s14.3 32 32 32H480c17.7 0 32-14.3 32-32s-14.3-32-32-32H192zm0 160c-17.7 0-32 14.3-32 32s14.3 32 32 32H480c17.7 0 32-14.3 32-32s-14.3-32-32-32H192zm0 160c-17.7 0-32 14.3-32 32s14.3 32 32 32H480c17.7 0 32-14.3 32-32s-14.3-32-32-32H192zM16 232v48c0 13.3 10.7 24 24 24H88c13.3 0 24-10.7 24-24V232c0-13.3-10.7-24-24-24H40c-13.3 0-24 10.7-24 24zM40 368c-13.3 0-24 10.7-24 24v48c0 13.3 10.7 24 24 24H88c13.3 0 24-10.7 24-24V392c0-13.3-10.7-24-24-24H40z"/></svg>
                        </div>
                    </div>
                    <div class="row-span-1 rounded-b-lg px-6 py-2 bg-black/50">                            
                        <h2 class="text-xl font-semibold text-gray-900 dark:text-white">Latest Decklists</h2>
            ...
            <a href="/featured" class="scale-100 bg-raichu bg-cover via-transparent dark:ring-1 dark:ring-inset dark:ring-white/5 rounded-lg shadow-2xl shadow-gray-500/20 dark:shadow-none flex motion-safe:hover:scale-[1.01] transition-all duration-250 focus:outline focus:outline-2 focus:outline-indigo-500">
                <div class="rounded-lg w-full grid grid-rows-3">
                    <div class="row-span-2 items-center flex">
                        <div class="mx-6 flex items-center justify-center w-16 h-16 rounded-full bg-indigo-50 dark:bg-slate-900/20">
                            <svg class="text-slate-100 fill-current w-7 h-7" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 576 512"><!--!Font Awesome Free 6.5.2 by @fontawesome - https://fontawesome.com License - https://fontawesome.com/license/free Copyright 2024 Fonticons, Inc.--><path d="M316.9 18C311.6 7 300.4 0 288.1 0s-23.4 7-28.8 18L195 150.3 51.4 171.5c-12 1.8-22 10.2-25.7 21.7s-.7 24.2 7.9 32.7L137.8 329 113.2 474.7c-2 12 3 24.2 12.9 31.3s23 8 33.8 2.3l128.3-68.5 128.3 68.5c10.8 5.7 23.9 4.9 33.8-2.3s14.9-19.3 12.9-31.3L438.5 329 542.7 225.9c8.6-8.5 11.7-21.2 7.9-32.7s-13.7-19.9-25.7-21.7L381.2 150.3 316.9 18z"/></svg> 
                        </div>
                    </div>
                    <div class="row-span-1 rounded-b-lg px-6 py-2 bg-black/50">                            
                        <h2 class="text-xl font-semibold text-gray-900 dark:text-white">Featured Decks</h2>

                        <p class="mt-4 text-sm leading-relaxed text-gray-500 dark:text-gray-400">
                            Take a look at featured decklists handpicked by our site.
                        </p>
                    </div>

                </div>
            </a>
            <a href="/tournaments" class="scale-100 bg-blastoise bg-cover via-transparent dark:ring-1 dark:ring-inset dark:ring-white/5 rounded-lg shadow-2xl shadow-gray-500/20 dark:shadow-none flex motion-safe:hover:scale-[1.01] transition-all duration-250 focus:outline focus:outline-2 focus:outline-indigo-500">
                <div class="rounded-lg w-full grid grid-rows-3">
                    <div class="row-span-2 items-center flex">
                        <div class="mx-6 flex items-center justify-center w-16 h-16 rounded-full bg-indigo-50 dark:bg-slate-900/20">
                    ...
                    <div class="row-span-1 rounded-b-lg px-6 py-2 bg-black/50">                            
                        <h2 class="text-xl font-semibold text-gray-900 dark:text-white">Latest Tournaments</h2>
    ...
    <div class="flex justify-center px-0 mt-16 sm:items-center sm:justify-between">
        <div class="text-sm text-center text-gray-500 dark:text-gray-400 sm:text-left">
            <div class="flex items-center gap-4">
                <a href="https://ko-fi.com/autumnzephyrs" class="inline-flex items-center group hover:text-gray-700 dark:hover:text-white focus:outline focus:outline-2 focus:rounded-sm focus:outline-indigo-500">
                    ...
                    Consider donating to help upkeep the site!
                </a>
            </div>
        </div>
