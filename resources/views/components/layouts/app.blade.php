...
<html lang="{{ str_replace('_', '-', app()->getLocale()) }}">
    ...
    <body class="min-h-screen flex flex-col">
        ...
        <nav class="sticky top-0 flex-no-wrap lg:flex-wrap flex h-20 w-screen z-50 items-center px-12 dark:bg-gray-800 border-b border-gray-100 dark:border-gray-700 drop-shadow-xl">
            @if (Route::has('login'))
                <div class="pr-6 flex justify-between w-full">
                    <div class="flex">
                        <a href="/" class="mr-6 font-bold font-semibold text-gray-900 dark:text-white">📡 HOLON RESEARCH TOWER 📡</a>
