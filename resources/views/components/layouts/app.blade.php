...
<html lang="{{ str_replace('_', '-', app()->getLocale()) }}">
    ...
    <body class="overflow-hidden">
        <div class="min-h-screen flex flex-col">
            <nav class="sticky flex top-0 h-20 w-screen z-50 items-center px-12 dark:bg-gray-800 border-b border-gray-100 dark:border-gray-700 drop-shadow-xl">
                @if (Route::has('login'))
                    <div class="pr-6 flex justify-between w-full">
                        <div class="flex">
                            <a href="/" class="mr-6 font-bold font-semibold text-gray-900 dark:text-white">🦌 PUSHAWAY RSPK 🦌</a>
                            <a href="{{ route('latest') }}" class="mx-2 flex items-center gap-1 font-semibold text-gray-600 hover:text-gray-900 dark:text-gray-400 dark:hover:text-white focus:outline focus:outline-2 focus:rounded-sm focus:outline-indigo-500">
                            ...
                            <a href="{{ route('articles') }}" class="mx-2 flex items-center gap-1 font-semibold text-gray-600 hover:text-gray-900 dark:text-gray-400 dark:hover:text-white focus:outline focus:outline-2 focus:rounded-sm focus:outline-indigo-500">
            ...
            <div class="absolute overflow-y-auto top-20 flex-1 h-full w-full bg-center sm:flex sm:justify-center bg-dots dark:bg-gray-900 selection:bg-indigo-500 selection:text-white">
                @yield('content')
